...
def get_messages():
    return get_string(lambda len_: raw_api.GetMessagesLength(len_),
...
def get_exception_message():
    return get_string(lambda len_: raw_api.GetExceptionMessageLength(len_),
                      method=raw_api.GetExceptionMessage)


def get_exception_stack():
    return get_string(lambda len_: raw_api.GetExceptionStackLength(len_),
